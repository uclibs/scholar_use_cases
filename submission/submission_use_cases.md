...
`So that:` I do not enter in a password that is less than the required length 
...
`I want to:`  click a ‘Log Out’ button instead of navigating to my name and clicking ‘Log Out’ 
